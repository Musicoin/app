...
import {View, Text, StyleSheet, Platform, FlatList, BackHandler, TouchableOpacity, Dimensions} from 'react-native';
          ...
          <View style={{paddingHorizontal: 16, paddingVertical: 16, width: width, backgroundColor: Colors.tabBar}}>
            <View style={{flexDirection: 'row', alignItems: 'center'}}>
              ...
              <View style={{flex: 1, alignItems: 'center', justifyContent: 'center', marginHorizontal: 10}}>
                <Text numberOfLines={1} style={{color: Colors.fontColor, fontSize: 18}}>Queue</Text>
              </View>
            </View>
          </View>
...
export default connectAlert(connect(mapStateToProps, {playTrack, togglePlayerMode})(QueueScreen));
